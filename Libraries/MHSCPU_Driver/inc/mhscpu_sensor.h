...
#define IS_SENSOR_PORT(PORT)                        ((((PORT) & ~SENSOR_Port_All == 0x00) && ((PORT) != (uint32_t)0x00))
...
#define IS_SENSOR_ANA(ANA)                          ((((ANA) & ~SENSOR_ANA_ALL) == 0x00) && ((ANA) != (uint32_t)0x00))
...
#define SENSOR_LOCK_ALL                             ((uint32_t)0x000000FF)
#define IS_SENSOR_LOCK(LOCK)                        ((((LOCK) & ~SENSOR_LOCK_ALL) == 0x00) && ((LOCK) != (uint32_t)0x00))
