...
#define CACHE_SIZE                            ((uint32_t)0x2000)
...
#define CACHE_CODE_BUS_SET_WIDTH                (6)
#define CACHE_CODE_BUS_SET_MASK                 ((uint32_t)0x003F)

#define CACHE_CODE_BUS_TAG_POS                  (11)
#define CACHE_CODE_BUS_TAG_WIDTH                (13)
#define CACHE_CODE_BUS_TAG_MASK                 ((uint32_t)0x01FFF)
